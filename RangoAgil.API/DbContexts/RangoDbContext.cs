...
public class RangoDbContext : DbContext
{
    ...
    {
        //Alimentando a entidade Ingrediente
        ...
        //Unindo as duas unidades por Id em uma outra tabela
        _ = modelBuilder
            .Entity<Rango>()//A entidade Rango
            .HasMany(d => d.Ingredientes)//tem muitos ingredientes
            .WithMany(i => i.Rangos)// ingredientes com muitos rangos
            .UsingEntity(e => e.HasData(//Configuração da ligação
